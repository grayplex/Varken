...
class DBManager(object):
    def __init__(self, server):
        ...
        self.influx = InfluxDBClient(url=url, token=token, verify_ssl=self.server.verify_ssl, org=self.server.org)
    ...
    def create_v1_database(self):
        ...
        database = [db['name'] for db in client.get_list_database()]
